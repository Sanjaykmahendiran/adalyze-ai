...
async function getBlogPostById(slug: string): Promise<BlogPost | null> {
    try {
        const response = await fetch(`https://adalyzeai.xyz/App/tapi.php?gofor=getblog&slug=${slug}`, {
            cache: 'no-store'
        })
...
async function getAllBlogPosts(): Promise<BlogPost[]> {
    try {
        const response = await fetch("https://adalyzeai.xyz/App/tapi.php?gofor=blogslist", {
            cache: 'no-store'
        })
