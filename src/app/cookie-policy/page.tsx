...
export default function CookiePolicyPage() {
    ...
    useEffect(() => {
        const fetchPrivacyPolicy = async () => {
            try {
                const response = await fetch("https://adalyzeai.xyz/App/tapi.php?gofor=cookiepolicy");
                ...
                setError(error instanceof Error ? error.message : 'Failed to load Cookie Policy');
            } finally {
                setLoading(false);
            }
        };
                ...
                <div className="container mx-auto px-4 py-8">
                    <div className="text-center py-12">
                        <div className="bg-red-50 border border-red-200 rounded-lg p-6 max-w-md mx-auto">
                            <h2 className="text-xl font-semibold text-red-800 mb-2">Unable to Load Cookie Policy</h2>
    ...
    if (!privacy) {
        return (
            <div className="min-h-screen">
                ...
                <div className="container mx-auto px-4 py-8">
                    <div className="text-center py-12">
                        <h2 className="text-2xl font-semibold text-gray-800 mb-2">Cookie Policy Not Available</h2>
                        <p className="text-gray-600">The Cookie Policy content could not be found.</p>
                    </div>
                </div>
                <LandingPageFooter />
            </div>
            ...
            <div className="container mx-auto px-4 py-8 pt-24">
                <main className="prose prose-gray max-w-none">
                    ...
                    <div className="mt-6 flex justify-center">
                        <div
                            className="max-w-[800px] w-full font-thin privacy-content mt-10"
