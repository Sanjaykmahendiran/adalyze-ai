          ...
          {steps.map((step, index) => {
            ...
            return (
              ...
              >
                ...
                <motion.div
                  className={`relative rounded-xl sm:rounded-2xl overflow-x-hidden overflow-y-visible mt-14 sm:mt-10 bg-black border border-[#db4900]/50 p-4 sm:p-6 md:p-8 lg:p-12 w-full max-w-5xl mx-auto ${reverse ? "md:flex-row-reverse" : ""
                    }`}
                  initial="hidden"
                  whileInView="show"
                ...
                >
                  <div className="flex flex-col md:flex-row items-center gap-6 sm:gap-8">
                    ...
                    {/* Text Content */}
                    <motion.div
                      className={`flex-1 text-white ${reverse ? "md:pl-6 lg:pl-8" : "md:pr-6 lg:pr-8"}`}
