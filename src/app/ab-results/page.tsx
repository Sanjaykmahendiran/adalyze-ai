...
export default function ABTestResults() {
        ...
        const fetchAdDetails = async () => {
            try {
                ...
                const [responseA, responseB] = await Promise.all([
                    fetch(`https://adalyzeai.xyz/App/tapi.php?gofor=addetail&ad_upload_id=${adIdA}${userIdParam}`),
                    fetch(`https://adalyzeai.xyz/App/tapi.php?gofor=addetail&ad_upload_id=${adIdB}${userIdParam}`),
                ]);
    ...
    const fetchABTestWinner = async () => {
        try {
            ...
            const response = await fetch(
                `https://adalyzeai.xyz/App/tapi.php?gofor=abaddetail&ad_upload_id1=${adIdA}&ad_upload_id2=${adIdB}`
            );
    ...
    const handleDeleteAbAd = async () => {
        ...
        try {
            const response = await fetch(`https://adalyzeai.xyz/App/tapi.php?gofor=deleteabad&ad_upload_id_a=${adIdA}&ad_upload_id_b=${adIdB}`);
