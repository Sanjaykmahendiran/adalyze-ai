        ...
        return (
            <div className="flex flex-col space-y-6 rounded-3xl bg-[#db4900] p-8 text-white">
                ...
                {file ? (
                    ...
                    <div
                        className={`flex min-h-[200px] w-full cursor-pointer flex-col items-center justify-center rounded-2xl bg-[#121212] p-6 text-center transition-all ${isDragging ? "border-4 border-dashed border-gray-400 bg-cyan-50" : "hover:bg-[#2b2b2b] text-white"
                            }`}
